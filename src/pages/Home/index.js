...
const Home = () => (
    <div>
        ...
        <section>
            <h1 className='text-white sm:posicionamento image-fundo bg-yellow-dev flex items-center justify-center text-6xl font-bold'>SORVETE ARTESANAL</h1>
        </section>
        ...
        <main className="">
            ...
            <section className="lg:flex xl:flex 2xl:flex">
                ...
                <div className='flex flex-col justify-center items-center py-20 px-16'>
