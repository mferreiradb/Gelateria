    ...
    <div>
        ...
        <main className="">
            ...
            <section className="lg:flex xl:flex 2xl:flex">
                ...
                <img className="md:w-full lg:w-2/4 xl:w-2/4 2xl:w-2/4" src={Banner} alt="banner" />
...
\
            <section className="lg:flex lg:flex-row-reverse xl:flex xl:flex-row-reverse 2xl:flex 2xl:flex-row-reverse">
                ...
                <img className="md:w-full lg:w-2/4 xl:w-2/4 2xl:w-2/4" src={Eventos} alt="Eventos-foto" />

                <div className='flex flex-col justify-center items-center lg:w-2/4 xl:w-2/4 2xl:w-2/4 py-20 px-16'>
            ...
            <section className="lg:flex xl:flex 2xl:flex">
                ...
                <img className="md:w-full lg:w-2/4 xl:w-2/4 2xl:w-2/4" src={Sobre} alt="Sobre-foto" />
