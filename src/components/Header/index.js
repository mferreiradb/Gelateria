...
export default function Header() {
    ...
    return (
    <header className='px-4 fixed z-10 w-screen bg-yellow-dev flex flex-col items-center md:flex-row md:space-x-80 lg:justify-center xl:justify-center 2xl:justify-center'>
